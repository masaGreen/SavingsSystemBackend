...
public class AccountTypeService {
    ...
    public AccountType findByAccountTypeByName(String id) {
        return accountTypeRepository.findByName(id).orElseThrow(() -> new EntityNotFoundException("AccountType not found"));
    ...
    public String createAccountType(CreateAccountTypeDTO createAccountTypeDTO) {
        ...
        if (isExistent) throw new EntityExistsException("accountType already exists");
    ...
    public String editAccountType(EditAccountType editAccountType, String name) {
        //does account exist
        AccountType accountType = accountTypeRepository.findByName(name).orElseThrow(() -> new EntityNotFoundException("Can't edit account that does not exist"));
